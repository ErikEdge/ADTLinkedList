...
class LinkedListTests {
	...
	/**
	 * Tests the exception when index out of bound.
	 */
	@Test
	void testException() {
		this.linkedList.append("a");
		...
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.replace("5",-1),"Index are larger than the list size");
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.replace("5", 4),"Index are larger than the list size");
		
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.delete(-1),"Index are larger than the list size");
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.delete(4),"Index are larger than the list size");
		
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.insert("5",-1),"Index are larger than the list size");
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.insert("5", 4),"Index are larger than the list size");
		
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.retrieve(-1),"Index are larger than the list size");
		assertThrows(IndexOutOfBoundsException.class, () -> this.linkedList.retrieve(4),"Index are larger than the list size");
	}
	
	/**
	 * Tests a few possible outcomes left.
	 */
	@Test
	void testReturn() {
		this.linkedList.prepend("a");
